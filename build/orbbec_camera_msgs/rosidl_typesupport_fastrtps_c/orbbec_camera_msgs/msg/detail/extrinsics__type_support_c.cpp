...
#include "orbbec_camera_msgs/msg/detail/extrinsics__rosidl_typesupport_fastrtps_c.h"
...
using _Extrinsics__ros_msg_type = orbbec_camera_msgs__msg__Extrinsics;
...
size_t get_serialized_size_orbbec_camera_msgs__msg__Extrinsics(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Extrinsics__ros_msg_type * ros_message = static_cast<const _Extrinsics__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Extrinsics__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_orbbec_camera_msgs__msg__Extrinsics(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_orbbec_camera_msgs
size_t max_serialized_size_orbbec_camera_msgs__msg__Extrinsics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Extrinsics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_orbbec_camera_msgs__msg__Extrinsics(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, orbbec_camera_msgs, msg, Extrinsics)() {
