...
static const _RobotArmArray_Request_type_support_symbol_names_t _RobotArmArray_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, faithcar_msgs, srv, RobotArmArray_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, faithcar_msgs, srv, RobotArmArray_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, faithcar_msgs, srv, RobotArmArray_Request)() {
  return &::faithcar_msgs::srv::rosidl_typesupport_c::RobotArmArray_Request_message_type_support_handle;
}
...
static const _RobotArmArray_Response_type_support_symbol_names_t _RobotArmArray_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, faithcar_msgs, srv, RobotArmArray_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, faithcar_msgs, srv, RobotArmArray_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, faithcar_msgs, srv, RobotArmArray_Response)() {
  return &::faithcar_msgs::srv::rosidl_typesupport_c::RobotArmArray_Response_message_type_support_handle;
}
...
static const _RobotArmArray_type_support_symbol_names_t _RobotArmArray_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, faithcar_msgs, srv, RobotArmArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, faithcar_msgs, srv, RobotArmArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, faithcar_msgs, srv, RobotArmArray)() {
  return &::faithcar_msgs::srv::rosidl_typesupport_c::RobotArmArray_service_type_support_handle;
}
