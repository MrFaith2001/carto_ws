...
static const _Kinemarics_Request_type_support_symbol_names_t _Kinemarics_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, faithcar_msgs, srv, Kinemarics_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, faithcar_msgs, srv, Kinemarics_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, faithcar_msgs, srv, Kinemarics_Request)() {
  return &::faithcar_msgs::srv::rosidl_typesupport_c::Kinemarics_Request_message_type_support_handle;
}
...
static const _Kinemarics_Response_type_support_symbol_names_t _Kinemarics_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, faithcar_msgs, srv, Kinemarics_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, faithcar_msgs, srv, Kinemarics_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, faithcar_msgs, srv, Kinemarics_Response)() {
  return &::faithcar_msgs::srv::rosidl_typesupport_c::Kinemarics_Response_message_type_support_handle;
}
...
static const _Kinemarics_type_support_symbol_names_t _Kinemarics_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, faithcar_msgs, srv, Kinemarics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, faithcar_msgs, srv, Kinemarics)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, faithcar_msgs, srv, Kinemarics)() {
  return &::faithcar_msgs::srv::rosidl_typesupport_c::Kinemarics_service_type_support_handle;
}
