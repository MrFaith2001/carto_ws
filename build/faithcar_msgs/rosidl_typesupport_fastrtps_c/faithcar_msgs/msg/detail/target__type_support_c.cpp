...
#include "faithcar_msgs/msg/detail/target__rosidl_typesupport_fastrtps_c.h"
...
using _Target__ros_msg_type = faithcar_msgs__msg__Target;
...
static uint32_t _Target__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_faithcar_msgs__msg__Target(
...
static size_t _Target__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_faithcar_msgs__msg__Target(
