...
#include "faithcar_msgs/msg/detail/arm_joint__rosidl_typesupport_fastrtps_c.h"
...
using _ArmJoint__ros_msg_type = faithcar_msgs__msg__ArmJoint;
...
size_t get_serialized_size_faithcar_msgs__msg__ArmJoint(
  const void * untyped_ros_message,
...
static uint32_t _ArmJoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_faithcar_msgs__msg__ArmJoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_faithcar_msgs
size_t max_serialized_size_faithcar_msgs__msg__ArmJoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ArmJoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_faithcar_msgs__msg__ArmJoint(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, faithcar_msgs, msg, ArmJoint)() {
