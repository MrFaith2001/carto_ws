...
#include "faithcar_msgs/srv/detail/kinemarics__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const faithcar_msgs::srv::Kinemarics_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<faithcar_msgs::srv::Kinemarics_Request *>(
    untyped_ros_message);
...
{
  return &faithcar_msgs::srv::typesupport_fastrtps_cpp::_Kinemarics_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const faithcar_msgs::srv::Kinemarics_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<faithcar_msgs::srv::Kinemarics_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &faithcar_msgs::srv::typesupport_fastrtps_cpp::_Kinemarics_Response__handle;
}
...
{
  return &faithcar_msgs::srv::typesupport_fastrtps_cpp::_Kinemarics__handle;
}
