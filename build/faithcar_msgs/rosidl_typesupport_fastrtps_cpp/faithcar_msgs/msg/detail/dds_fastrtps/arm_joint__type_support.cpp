...
#include "faithcar_msgs/msg/detail/arm_joint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const faithcar_msgs::msg::ArmJoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  faithcar_msgs::msg::ArmJoint & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const faithcar_msgs::msg::ArmJoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<faithcar_msgs::msg::ArmJoint *>(
    untyped_ros_message);
...
{
  return &faithcar_msgs::msg::typesupport_fastrtps_cpp::_ArmJoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, faithcar_msgs, msg, ArmJoint)() {
  return &faithcar_msgs::msg::typesupport_fastrtps_cpp::_ArmJoint__handle;
}
