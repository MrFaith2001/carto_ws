...
#include "faithcar_msgs/msg/detail/target_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const faithcar_msgs::msg::Target &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  faithcar_msgs::msg::Target &);
...
cdr_serialize(
  const faithcar_msgs::msg::TargetArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
  {
    ...
    for (size_t i = 0; i < size; i++) {
      faithcar_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.data[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  faithcar_msgs::msg::TargetArray & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      faithcar_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        faithcar_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        faithcar_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Target(
...
{
  auto typed_message =
    static_cast<const faithcar_msgs::msg::TargetArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<faithcar_msgs::msg::TargetArray *>(
    untyped_ros_message);
...
{
  return &faithcar_msgs::msg::typesupport_fastrtps_cpp::_TargetArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, faithcar_msgs, msg, TargetArray)() {
  return &faithcar_msgs::msg::typesupport_fastrtps_cpp::_TargetArray__handle;
}
