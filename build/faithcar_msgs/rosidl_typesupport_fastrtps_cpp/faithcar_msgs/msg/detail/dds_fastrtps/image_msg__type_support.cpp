...
#include "faithcar_msgs/msg/detail/image_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const faithcar_msgs::msg::ImageMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  faithcar_msgs::msg::ImageMsg & ros_message)
{
  // Member: height
  cdr >> ros_message.height;
...
{
  auto typed_message =
    static_cast<const faithcar_msgs::msg::ImageMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<faithcar_msgs::msg::ImageMsg *>(
    untyped_ros_message);
...
{
  return &faithcar_msgs::msg::typesupport_fastrtps_cpp::_ImageMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, faithcar_msgs, msg, ImageMsg)() {
  return &faithcar_msgs::msg::typesupport_fastrtps_cpp::_ImageMsg__handle;
}
