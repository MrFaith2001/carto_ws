...
{
  new (message_memory) faithcar_msgs::msg::ArmJoint(_init);
}

void ArmJoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<faithcar_msgs::msg::ArmJoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArmJoint_message_member_array[4] = {
  {
    ...
    offsetof(faithcar_msgs::msg::ArmJoint, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(faithcar_msgs::msg::ArmJoint, run_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(faithcar_msgs::msg::ArmJoint, angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(faithcar_msgs::msg::ArmJoint, joints),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArmJoint_message_members = {
  ...
  4,  // number of fields
  sizeof(faithcar_msgs::msg::ArmJoint),
...
get_message_type_support_handle<faithcar_msgs::msg::ArmJoint>()
{
  return &::faithcar_msgs::msg::rosidl_typesupport_introspection_cpp::ArmJoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, faithcar_msgs, msg, ArmJoint)() {
  return &::faithcar_msgs::msg::rosidl_typesupport_introspection_cpp::ArmJoint_message_type_support_handle;
}
