...
bool faithcar_msgs__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("faithcar_msgs.msg._target.Target", full_classname_dest, 32) == 0);
  }
  faithcar_msgs__msg__Target * ros_message = _ros_message;
  {  // frame_id
...
PyObject * faithcar_msgs__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("faithcar_msgs.msg._target");
