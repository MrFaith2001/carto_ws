...
class Metaclass_Kinemarics(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from faithcar_msgs.srv import _kinemarics
...
class Kinemarics(metaclass=Metaclass_Kinemarics):
    from faithcar_msgs.srv._kinemarics import Kinemarics_Request as Request
    from faithcar_msgs.srv._kinemarics import Kinemarics_Response as Response
