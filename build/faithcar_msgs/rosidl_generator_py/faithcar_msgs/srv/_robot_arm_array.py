...
class Metaclass_RobotArmArray_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('faithcar_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_RobotArmArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'faithcar_msgs.srv.RobotArmArray')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from faithcar_msgs.srv import _robot_arm_array
...
class RobotArmArray(metaclass=Metaclass_RobotArmArray):
    from faithcar_msgs.srv._robot_arm_array import RobotArmArray_Request as Request
    from faithcar_msgs.srv._robot_arm_array import RobotArmArray_Response as Response
