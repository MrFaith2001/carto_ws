...
bool faithcar_msgs__msg__arm_joint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("faithcar_msgs.msg._arm_joint.ArmJoint", full_classname_dest, 37) == 0);
  }
  faithcar_msgs__msg__ArmJoint * ros_message = _ros_message;
  {  // id
...
PyObject * faithcar_msgs__msg__arm_joint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("faithcar_msgs.msg._arm_joint");
