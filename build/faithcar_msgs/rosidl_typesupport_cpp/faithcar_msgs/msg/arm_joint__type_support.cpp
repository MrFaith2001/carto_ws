...
static const _ArmJoint_type_support_symbol_names_t _ArmJoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, faithcar_msgs, msg, ArmJoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, faithcar_msgs, msg, ArmJoint)),
  }
};
...
{
  return &::faithcar_msgs::msg::rosidl_typesupport_cpp::ArmJoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, faithcar_msgs, msg, ArmJoint)() {
  return get_message_type_support_handle<faithcar_msgs::msg::ArmJoint>();
}
