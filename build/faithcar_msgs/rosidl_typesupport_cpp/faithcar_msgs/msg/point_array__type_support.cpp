...
static const _PointArray_type_support_symbol_names_t _PointArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, faithcar_msgs, msg, PointArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, faithcar_msgs, msg, PointArray)),
  }
};
...
get_message_type_support_handle<faithcar_msgs::msg::PointArray>()
{
  return &::faithcar_msgs::msg::rosidl_typesupport_cpp::PointArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, faithcar_msgs, msg, PointArray)() {
  return get_message_type_support_handle<faithcar_msgs::msg::PointArray>();
}
