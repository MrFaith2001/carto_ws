...
static const _Kinemarics_Request_type_support_symbol_names_t _Kinemarics_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, faithcar_msgs, srv, Kinemarics_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, faithcar_msgs, srv, Kinemarics_Request)),
  }
};
...
{
  return &::faithcar_msgs::srv::rosidl_typesupport_cpp::Kinemarics_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, faithcar_msgs, srv, Kinemarics_Request)() {
  return get_message_type_support_handle<faithcar_msgs::srv::Kinemarics_Request>();
}
...
static const _Kinemarics_Response_type_support_symbol_names_t _Kinemarics_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, faithcar_msgs, srv, Kinemarics_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, faithcar_msgs, srv, Kinemarics_Response)),
  }
};
...
{
  return &::faithcar_msgs::srv::rosidl_typesupport_cpp::Kinemarics_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, faithcar_msgs, srv, Kinemarics_Response)() {
  return get_message_type_support_handle<faithcar_msgs::srv::Kinemarics_Response>();
}
...
static const _Kinemarics_type_support_symbol_names_t _Kinemarics_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, faithcar_msgs, srv, Kinemarics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, faithcar_msgs, srv, Kinemarics)),
  }
};
...
{
  return &::faithcar_msgs::srv::rosidl_typesupport_cpp::Kinemarics_service_type_support_handle;
}
