...
bool faithcar_msgs__msg__image_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("faithcar_msgs.msg._image_msg.ImageMsg", full_classname_dest, 37) == 0);
  }
  faithcar_msgs__msg__ImageMsg * ros_message = _ros_message;
  {  // height
...
{
  /* NOTE(esteve): Call constructor of ImageMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("faithcar_msgs.msg._image_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImageMsg");
