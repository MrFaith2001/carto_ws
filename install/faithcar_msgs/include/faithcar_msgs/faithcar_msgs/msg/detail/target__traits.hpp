...
#ifndef FAITHCAR_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
#define FAITHCAR_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
...
inline void to_yaml(
  const faithcar_msgs::msg::Target & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const faithcar_msgs::msg::Target & msg)
{
  return faithcar_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<faithcar_msgs::msg::Target>()
{
  return "faithcar_msgs::msg::Target";
}

template<>
inline const char * name<faithcar_msgs::msg::Target>()
{
  return "faithcar_msgs/msg/Target";
}

template<>
struct has_fixed_size<faithcar_msgs::msg::Target>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<faithcar_msgs::msg::Target>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<faithcar_msgs::msg::Target>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // FAITHCAR_MSGS__MSG__DETAIL__TARGET__TRAITS_HPP_
